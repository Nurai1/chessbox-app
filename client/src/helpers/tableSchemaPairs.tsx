...
export const tableSchemaPairs = (tableData: PairSchema[], participants: UserSchema[]) => {
    ...
    const statusStyle = 'uppercase text-sm md:col-start-2 md:col-end-3 md:row-start-2 md:row-end-3 xl:row-auto xl:col-start-3 xl:col-end-4 xl:text-base xl:font-bold'
    ...
    return participantsData.map((pair, i) => {
        return {
            cells: [
                ...
                {
                    node: (
                        <div className='grid grid-cols-[1fr_80px] gap-[14px] w-full lg:grid-cols-[1fr_110px] lg:gap-[28px] xl:grid-cols-[25%_50%_10%] xl:gap-[5%]'>
                            <div className='md:col-start-1 md:col-end-3 xl:col-auto'>
                                <p className='gri mb-[6px] text-black text-base xl:font-bold'>Starts time</p>
                                <div className='flex gap-[8px]'>
                                    <WhatsappIcon className='xl:min-w-[24px] xl:h-[24px]'/>
                                    <p className='text-xs xl:text-base'>Judge: {pair.judge}</p>
                                </div>
                            </div>
                            ...
                            <div className='flex justify-between col-start-1 col-end-3 md:col-end-2 xl:col-start-2 xl:col-end-3 xl:row-start-1 xl:row-end-2'>
                                <div className='w-[45%]'>
                                    <p className='mb-[7px] text-sm text-black xl:text-base'>{pair.blackParticipantData?.fullName}</p>
                                    <p className='text-xs xl:text-base'>{pair.blackParticipantData?.age} age, {pair.blackParticipantData?.weight} kg</p>
                                </div>
                                ...
                                <div className='w-[45%]'>
                                    <div className='ml-auto w-fit'>
                                        ...
                                        <p className=' text-xs xl:text-base'>{pair.whiteParticipantData?.age} age, {pair.whiteParticipantData?.weight} kg</p>
                                    </div>
                                </div>
                            </div>
                        </div>
