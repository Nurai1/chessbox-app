...
import { fetchCompetitionById } from '../store/slices/competitionSlice'
import { Loader, Tag, Timer, Button, Modal } from '../ui'
...
export const CompetitionPage = (): ReactElement => {
	...
	// const loading = useAppSelector(s => s.competition.loading)
					...
					<div>
						...
						<div className='mb-[35px] flex flex-wrap gap-4 xl:mb-[64px]'>
							{competitionData.price && (
								<Tag img={<Banknote className='max-5 mr-2' />} text={`Price ${competitionData.price.currentValue} $`} />
							)}
