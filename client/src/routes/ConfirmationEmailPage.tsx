	...
	return (
		<main className='flex grow flex-col bg-pale-white py-[20px]'>
			<form className='m-auto max-w-[488px] rounded-[6px] bg-white p-[30px_17px] md:p-[35px_57px]'>
				<h1 className='mb-[8px] text-center text-heading-4'>Email Confirmation</h1>
				<div className='flex flex-col items-center gap-[18px]'>
					{encodedEmail && <span className='font-medium'>Account Email: {decodeURIComponent(encodedEmail)}</span>}
