        ...
        <div className="flex w-full flex-wrap font-normal leading-none">
            ...
            <div className="relative w-full text-sm">
                {multiple ? (
                    ...
                    >
                        <div
                            className={twMerge('relative z-10 w-full cursor-pointer rounded-md bg-white pr-14', selectClasses)}>
                            <div
                                className="box-border flex h-16 w-full items-center gap-x-1.5 overflow-x-auto pl-4 font-medium text-gray-500">
                                ...
                                {chosenOptions?.map(option => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <span
                                                className="h-4 whitespace-nowrap">{option?.renderNode || option?.value}</span>
                                            <span
                                                className="inline-flex h-4 w-4 items-center justify-center rounded-full bg-gray-200 text-gray-500">
												<CrossIcon/>
											</span>
                                        </button>
                                    )
                ...
                >
                    ...
                    <div className="flex flex-col">
                        {dropdownPlaceholder && <span className='flex items-center min-h-[3rem] pl-3 font-bold [&:not(:last-child)]:border-b [&:not(:last-child)]:border-zinc-300'>{dropdownPlaceholder}</span>}
                            ...
                            return (
                                ...
                                >
                                    {multiple && (
                                        <span
                                            className={twMerge(
                                                'inline-flex h-4 min-w-[1rem] items-center justify-center border rounded-full',
