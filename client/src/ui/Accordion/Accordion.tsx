...
export const Accordion: FC<AccordionPropsType>  = ({children, title, isDragable, classes, isActiveDefault = false})=> {
    ...
    return (
        <div className={twMerge('py-4 [&:not(:last-child)]:border-b [&:not(:last-child)]:border-zinc-300 xl:py-[1.62rem]', classes)}>
            <div className='flex items-center'>
                ...
                <button className='flex justify-between items-center gap-2 grow transition hover:opacity-70' onClick={() => setActive(!active)} type='button'>
                    {title}
